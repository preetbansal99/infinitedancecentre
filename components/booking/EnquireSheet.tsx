        ...
        >
          ...
          >
            ...
            <div className="p-6 flex-1 overflow-y-auto">
              {!success ? (
                <>
                  <h2 className="text-heading-md font-display font-bold text-text-primary mb-2">
                    Send Enquiry
                  </h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      <label className="text-caption text-text-secondary mb-1.5 block">
                      ...
                      <input
                        ...
                        className="w-full bg-surface-el border border-white/10 rounded-lg px-4 py-3 text-body-sm text-text-primary focus:border-accent-purple/50 focus:outline-none"
                        placeholder="Enter full name"
                      />
                      {errors.fullName && <p className="text-caption text-error mt-1">{errors.fullName}</p>}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          className="flex-1 bg-surface-el border border-white/10 rounded-lg px-4 py-3 text-body-sm text-text-primary focus:border-accent-purple/50 focus:outline-none"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-surface-el border border-white/10 rounded-lg px-4 py-3 text-body-sm text-text-primary focus:border-accent-purple/50 focus:outline-none appearance-none"
                      >
                        <option value="" disabled>Select a course</option>
                        {COURSES.map(c => <option key={c} value={c}>{c}</option>)}
                      </select>
                      {errors.courseName && <p className="text-caption text-error mt-1">{errors.courseName}</p>}
                    </div>
                ...
                <div className="flex flex-col items-center text-center py-4">
                  ...
                  <button
                    onClick={handleCopy}
                    className="mt-4 text-body-sm text-text-muted hover:text-text-secondary flex items-center gap-1.5 transition-colors"
                  >
                  ...
                  <button
                    onClick={handleClose}
                    className="mt-8 text-caption text-text-muted underline underline-offset-4 hover:text-text-secondary transition-colors"
                  >
                    Close
                  </button>
                </div>
