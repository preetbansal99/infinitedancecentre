...
const ABOUT_ITEMS = [
  ...
  },
  {
    ...
    text: "Trained by national-level dancers with 10+ years of teaching experience and genuine passion.",
  },
  {
    icon: Award,
    title: "Proven Results",
    text: "200+ active students, 4.9★ Google rating, and multiple annual showcase performances.",
  },
  {
    icon: Heart,
    title: "Community First",
    text: "A supportive, judgment-free space where every student feels welcome and encouraged.",
  },
];
